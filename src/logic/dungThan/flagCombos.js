...
const COMBO_TOPIC_ADVICE = {
  ...
  VOID_FAN_YIN: {
    ...
    'hoc-tap': {
      headline: 'Chống Nhiễu Tín Hiệu (Signal Noise)',
      coreMessage: 'Mọi thay đổi phút chót hoặc tin đồn "quay xe" về đề cương, đề thi đều là Ghost Signals.',
      narrative: 'Hệ thống đang bị dao động (Oscillation) nhưng không có dữ liệu thực (Null). Bạn thấy đề cương đổi liên tục? Đừng chạy theo, đó là bẫy logic.',
      doHint: 'Bám sát Logic nền tảng (Base Logic). Coi các tin đồn là Noise và lọc bỏ chúng.',
      avoidHint: 'Đừng hốt hoảng thay đổi phương pháp ôn tập vào giờ chót dựa trên các biến số Undefined.',
    },
    'thi-cu': {
      headline: 'Chống Nhiễu Tín Hiệu (Signal Noise)',
      coreMessage: 'Mọi thay đổi phút chót hoặc tin đồn "quay xe" về đề thi đều là Ghost Signals.',
      narrative: 'Hệ thống đang bị dao động (Oscillation) nhưng không có dữ liệu thực (Null). Bạn thấy đề cương đổi liên tục? Đừng chạy theo, đó là bẫy logic.',
      doHint: 'Bám sát Logic nền tảng (Base Logic). Coi các tin đồn là Noise và lọc bỏ chúng.',
      avoidHint: 'Đừng hốt hoảng thay đổi phương pháp ôn tập vào giờ chót dựa trên các biến số Undefined.',
    },
    'tai-van': {
      headline: 'Bẫy Reversal Giả',
      coreMessage: 'Tín hiệu đảo chiều (Reversal) chỉ là lớp vỏ rỗng, không có thanh khoản thực.',
      narrative: 'Đây là kịch bản "Fake Out" trong Trading. Đừng tưởng giá quay đầu là cơ hội, đó là vùng nhớ rỗng (Dead zone) đang dụ bạn vào.',
      doHint: 'Giữ lệnh ở trạng thái High-Z (Trở kháng cao - không tham gia). Đợi tín hiệu xác thực.',
      avoidHint: 'Tuyệt đối không "All-in" khi thấy biến động đảo chiều chưa có xác nhận từ dòng tiền thật.',
    },
    'tinh-duyen': {
    ...
    'muu-luoc': {
      headline: 'Chiến Thuật Zombie Process',
      coreMessage: 'Kế hoạch phản công trông như đang chạy nhưng thực chất không có Output.',
      narrative: 'Bạn đang định đổi chiến lược vì thấy đối thủ thay đổi? Cẩn thận, đó là một vòng lặp vô tận (Infinite Loop) không dẫn đến kết quả.',
      doHint: 'Hard Reset lại các giả định. Kiểm tra lại dữ liệu gốc thay vì chạy theo biến động bề nổi.',
      avoidHint: 'Đừng lãng phí tài nguyên cho các hành động phản ứng dựa trên dữ liệu ảo.',
    },
  },
