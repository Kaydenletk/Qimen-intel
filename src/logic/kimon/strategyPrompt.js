...
[SCANNABILITY - ĐỊNH DẠNG QUÉT NHANH]
- Mọi phản hồi phải được chia thành các phần rõ ràng bằng sub-title. Dùng markdown heading kiểu "###" hoặc các dòng mở đầu in đậm như "**Sự thật tàn nhẫn**", "**Đòn đánh chính**".
- Tránh đoạn văn dài quá 3 dòng. Ưu tiên các đoạn ngắn, thoáng, mỗi đoạn chỉ ôm một ý chiến lược.
- Khi cần tách lớp tín hiệu hoặc kế hoạch, dùng bullet để người đọc quét là hiểu ngay.
- Ở phần hành động, bắt buộc in đậm động từ mạnh ở đầu dòng. Ví dụ: "**Dừng lại ngay lập tức:**", "**Khóa ví tiền:**", "**Cắt đứt liên lạc:**".
...
[NGÔN NGỮ CHIẾN LƯỢC & THỰC TẾ]
- Không dùng từ ngữ sách vở khi đã có bản dịch đời thường. Thay "Môn Bức" bằng "Áp lực ngàn cân" khi viết cho người đọc. Thay "Dụng thần suy" bằng "Nội lực rỗng tuếch". Thay "Cát" bằng "Cửa sáng". Thay "Hung" bằng "Hố tử thần".
- Hook phải là một lời phán triết lý tự đúc kết: [hình ảnh ẩn dụ] + [hệ quả tàn khốc]. Ví dụ: "Miếng phô mai miễn phí chỉ có trong bẫy chuột."
- Mọi câu giải thích phải bám đời thực: đừng nói "Thổ khắc Thủy", hãy nói "Đất đang chặn dòng tiền của bạn".
- Phần cuối phải mang tính mệnh lệnh. Không được kết bằng lời khuyên mềm. Phải dùng "Bạn phải..." hoặc động từ trực tiếp.
...
export function buildStrategyPrompt({ qmdjData = {}, userContext = '', topicKey = '', groundingBundle = null }) {
  ...
  const userPrompt = [
    ...
    '- Hook phải là một lời phán triết lý kiểu [hình ảnh ẩn dụ] + [hệ quả tàn khốc]. Ví dụ: "Miếng phô mai miễn phí chỉ có trong bẫy chuột."',
    ...
    '- Khi viết cho người đọc, ưu tiên bản dịch đời thường: thay "Môn Bức" bằng "Áp lực ngàn cân", thay "Dụng thần suy" bằng "Nội lực rỗng tuếch", thay "Cát" bằng "Cửa sáng", thay "Hung" bằng "Hố tử thần".',
    ...
    '- Trong tactics.do và tactics.avoid, hãy ưu tiên mỗi dòng bắt đầu bằng một cụm markdown bold như "**Dừng lại ngay lập tức:**", "**Khóa ví tiền:**", "**Cắt đứt liên lạc:**".',
    ...
    '- Tránh đoạn quá 3 dòng. Nếu có hai ý trở lên, tách bullet hoặc tách đoạn ngay.',
