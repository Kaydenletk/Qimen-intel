...
assert.match(serverSource, /const forceStrategyTopic = false;/);
assert.match(serverSource, /const forceVerdictStrategy = false;/);
assert.match(serverSource, /const effectiveTier = isDeepDive \? 'strategy' : \(tier === 'companion' \? 'companion' : 'topic'\);/);
