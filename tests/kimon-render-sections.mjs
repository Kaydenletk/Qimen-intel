...
assert.match(serverSource, /const PREVIOUS_KYMON_MAX_OUTPUT_TOKENS = 2050;/, 'Phải giữ dấu vết giá trị token cũ để debug');
assert.match(serverSource, /const KYMON_MAX_OUTPUT_TOKENS = 2200;/, 'Backend Kymon phải tăng output length để giảm truncation');
